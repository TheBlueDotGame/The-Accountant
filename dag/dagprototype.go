...
func runGoshipPrototypeTest(print bool) {
	nodesCases := []struct {
		...
		{
			n:      newNode(),
			values: []int{60, 61, 62, 63, 64, 65, 66, 67, 68, 69},
		},
		{
			n:      newNode(),
			values: []int{70, 71, 72, 73, 74, 75, 76, 77, 78, 79},
		},
		{
			n:      newNode(),
			values: []int{80, 81, 82, 83, 84, 85, 86, 87, 88, 89},
		},
		{
			n:      newNode(),
			values: []int{90, 91, 92, 93, 94, 95, 96, 97, 98, 99},
		},
	}
	upperValuesRange := 99
