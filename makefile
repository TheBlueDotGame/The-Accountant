...
generate-protobuf:
	protoc --proto_path=protobuf --go-grpc_out=protobufcompiled --go_out=protobufcompiled --go-grpc_opt=paths=source_relative --go_opt=paths=source_relative computantistypes.proto wallet.proto gossip.proto notary.proto
