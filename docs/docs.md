...
layout: page
title: Documentation.
subtitle: Package: Blockchain, Wallet, REST API server, client and validator.
---
...
## type [CreateAddressResponse](<https://github.com/bartossh/Computantis/blob/main/server/rest.go#L258-L261>)
